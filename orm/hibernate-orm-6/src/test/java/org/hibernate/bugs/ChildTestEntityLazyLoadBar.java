...
/**
 * Child of {@link TestEntityLazyLoadBar}
 */
@Entity(name = "child_test_entity_lazy_load_bar")
@Table(name = "child_test_entity")
public class ChildTestEntityLazyLoadBar {
    ...
    TestEntityLazyLoadBar testEntity;
     ...
     */
    public TestEntityLazyLoadBar getTestEntity() {
     ...
     */
    public void setTestEntity(final TestEntityLazyLoadBar testEntity) {
