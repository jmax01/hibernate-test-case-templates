...
/**
 * The Class TestEntityLazyLoadBar.
 */

@Entity(name = "test_entity_lazy_load_bar")
@Table(name = "test_entity")
@SecondaryTable(name = "test_entity_foo_bar_vw", pkJoinColumns = @PrimaryKeyJoinColumn(name = "test_entity_id"))
public class TestEntityLazyLoadBar {
    ...
    ChildTestEntityLazyLoadBar childTestEntity;
     ...
     */
    protected void setTestEntityId(final UUID testEntityId) {
     ...
     */
    protected void setBusinessKey(final String businessKey) {
     ...
     */
    public ChildTestEntityLazyLoadBar getChildTestEntity() {
     ...
     */
    public void setChildTestEntity(final ChildTestEntityLazyLoadBar childTestEntity) {
